class Bindery < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bindery-md/bindery/releases/download/v0.1.0/bindery-macos-aarch64"
      sha256 "8a79170881323bdbf45ee405f45eeb7b274c7c2cc468168de5b069e629f4aa7a"
    end
    on_intel do
      url "https://github.com/bindery-md/bindery/releases/download/v0.1.0/bindery-macos-x86_64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/bindery-md/bindery/releases/download/v0.1.0/bindery-linux-aarch64"
      sha256 "647f764086dc976bd70dd3f03556a52eb50787b42d465f24bdba3a4122538f0c"
    end
    on_intel do
      url "https://github.com/bindery-md/bindery/releases/download/v0.1.0/bindery-linux-x86_64"
